...
2. Tighten the onboarding path first, then redesign the hardest decision so it feels lighter to move through.
3. By the end of the day, setup had a clearer path, a one-question-at-a-time introduction, and a swipeable way to choose a roster pattern.
