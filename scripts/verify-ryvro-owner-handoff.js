...
[
  ...
  ['Firebase Secret Manager is reachable', launchEvidenceLog],
  ['empty `secrets` version list', launchEvidenceLog],
  ['has no enabled secret version', launchEvidenceLog],
...
[
  ...
  ['Firebase billing plan upgrade from Spark to Blaze', submitBlockerTriage],
...
[
  ...
  ['Current blocker updated on 2026-06-06', firebaseOauthBackendHandoff],
  ['Firebase Secret Manager is reachable', firebaseOauthBackendHandoff],
  ['empty `secrets` version list', firebaseOauthBackendHandoff],
  ['has no enabled Secret Manager version', firebaseOauthBackendHandoff],
...
[
  ['CI run `27018502561`', readme],
  ['commit `ed43b3c`', readme],
  ['CI run `27018502561`', readinessReport],
