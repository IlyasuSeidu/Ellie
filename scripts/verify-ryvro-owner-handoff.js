...
[
  ...
  ['not Test Store only', launchEvidenceLog],
  [
    'both RevenueCat apps are saved against real App Store Connect and Google Play products',
    launchEvidenceLog,
  ],
  ['Google Play service account connected status', launchEvidenceLog],
  ['offering `default` references packages that grant it', launchEvidenceLog],
  ['paywall screenshot metadata if required', launchEvidenceLog],
  ['active for the testing track', launchEvidenceLog],
  ['package identifier, pricing metadata, trial metadata', launchEvidenceLog],
  ...
  ['match the live privacy policy, Firebase, RevenueCat', launchEvidenceLog],
  ['Google Play billing, AI provider, voice, analytics, diagnostics', launchEvidenceLog],
  ['account deletion, data deletion, and subscription behavior', launchEvidenceLog],
  ['Do not mark passed from the draft alone', launchEvidenceLog],
  ['Content rating and export compliance', launchEvidenceLog],
  ['Google Play content rating, Google Play target audience', launchEvidenceLog],
...
[
  ['CI run `27197394587`', readme],
  ['commit `3cc24e5`', readme],
  ['CI run `27197394587`', readinessReport],
  ['commit `3cc24e5`', readinessReport],
  ['CI run `27197394587`', ownerRunbook],
  ['commit `3cc24e5`', ownerRunbook],
