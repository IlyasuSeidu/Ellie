...
[
  ...
  ['HTTP `500` with non-secret error code `internal_error`', launchEvidenceLog],
  ['firebase login --reauth', launchEvidenceLog],
...
[
  ...
  ['HTTP `500` with non-secret error code `internal_error`', firebaseOauthBackendHandoff],
  ['Firebase CLI log inspection was blocked', firebaseOauthBackendHandoff],
