...
[
  ...
  [
    'targeted redeploy of `functions:ryvro-brain:parseShiftScheduleDescription` succeeded',
    launchEvidenceLog,
  ],
  ['HTTP `200` with `status` `needs_clarification`', launchEvidenceLog],
  ['incomplete-draft clarification', launchEvidenceLog],
...
[
  ...
  ['OpenAI quota or billing', submitBlockerTriage],
...
[
  ...
  ['HTTP `200` with `status` `needs_clarification`', firebaseOauthBackendHandoff],
  ['incomplete-draft clarification', firebaseOauthBackendHandoff],
