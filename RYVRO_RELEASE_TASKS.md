...
| 48  | 👤 RevenueCat → Offerings → create offering named `default` → add Annual package + Monthly package                                                                                                                | ✅ Done (offering `default` exists with annual package `$rc_annual` and monthly package `$rc_monthly`; store pricing, trial metadata, and production-equivalent purchase loading remain in Tasks 45, 46, and 49)                                                                                                                                                                                                                        |
