...
| 21  | Build production iOS binary: `eas build --platform ios --profile production`                                                                        | 🔧 Partial (EAS iOS build `c99b0e0a-829c-4ab7-bd93-164586ade68a` uploaded to TestFlight; rebuild still required after real Firebase/OAuth/RevenueCat env evidence) |
