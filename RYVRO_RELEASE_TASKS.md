...
| 14  | 👤 Create app in Google Play Console with matching name                                                                                                                                                                                                                                                                                                                         | 🔧 Partial (developer account created and registration fee completed; Play Console dashboard for `Ryvro` is reachable, but `Create app` is still disabled until Google account verification is finished. Latest Chrome progress reached Google's proof-of-address step and showed `Upload a proof of address document` with `Running a quick check`.) |
