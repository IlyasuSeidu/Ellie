...
| 21  | Build production iOS binary after running `npm run release:versions:get` and bumping remote EAS versions with `eas build:version:set`: `eas build --platform ios --profile production`                                                                                                                  | 🔧 Partial (EAS iOS build `71fde2ff-aa36-4741-aa69-e4f11ba30acd`, version `1.0.0`, build `2`, uploaded to App Store Connect through EAS Submit `b53825db-0f5c-4f56-b19e-c5af5f1999f3`; App Store Connect visual inspection showed build `2` as `Ready to Submit`; production-auth-ready EAS build `601af1ee-5192-442f-9caa-deef5b9b6120`, version `1.0.0`, build `4`, commit `1c4a8acbf05d804a363e3efe63f3010c34d6a3e8`, is queued and must finish before TestFlight submit and iPhone QA) |
