...
| 14  | 👤 Create app in Google Play Console with matching name                                                                                                                                                                                                                                                                                                                         | 🔧 Partial (developer account created and registration fee completed; Play Console dashboard for `Ryvro` is reachable, but `Create app` is disabled until Google account verification is finished: identity verification, Android mobile device access verification, and contact phone verification) |
