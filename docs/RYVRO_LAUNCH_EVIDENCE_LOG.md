...
| App Store Connect app name `Ryvro Shift Planner`                             | App Store Connect app ID / Apple ID and creation screenshot or dashboard note         | Pending owner evidence | Public Apple software search returned 5 fuzzy results and no exact `Ryvro` / `Ryvro Shift Planner` result at `2026-06-01T19:15:52.766Z`; still requires logged-in App Store Connect reservation.                                              |
