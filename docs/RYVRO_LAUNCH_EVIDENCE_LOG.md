...
| ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Formal trademark/legal clearance for `Ryvro`                                 | Counsel summary or trademark-search report reference for launch markets               | Pending owner evidence | Preliminary public preflight only: `npm run release:clearance` at `2026-05-31T20:33:40.206Z`; USPTO app reachable, not legal clearance.                                                                                                       |
| App Store Connect app name `Ryvro Shift Planner`                             | App Store Connect app ID / Apple ID and creation screenshot or dashboard note         | Pending owner evidence | Public Apple software search had no exact `Ryvro` / `Ryvro Shift Planner` result at `2026-05-31T20:33:40.206Z`; still requires logged-in App Store Connect reservation.                                                                       |
| Google Play title `Ryvro Shift Planner` and package `com.ryvro.shiftplanner` | Play Console app/package dashboard note                                               | Pending owner evidence | Public Google Play search had no exact `Ryvro` / `Ryvro Shift Planner` result at `2026-05-31T20:33:40.206Z`; visible fuzzy names were `Rydoo`, `Rydora`, `Ryver`, and `Ryver LLC`; still requires logged-in Play Console package/title check. |
| Domain control for `getryvro.com`                                            | Registrar receipt, DNS control proof, and live HTTPS check                            | Pending owner evidence | Public DNS had no records and Verisign `.com` returned no match for `getryvro.com` at `2026-05-31T20:33:40.206Z`; still requires registrar purchase/control proof.                                                                            |
| Social handles                                                               | Reserved handle list for X, Instagram, TikTok, YouTube, LinkedIn, or fallback handles | Pending owner evidence | Public URL statuses remain inconclusive; reserve `@ryvro` / fallbacks directly while logged in.                                                                                                                                               |
