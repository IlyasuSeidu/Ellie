...
| App Store Connect app name `Ryvro Shift Planner`                             | App Store Connect app ID / Apple ID and creation screenshot or dashboard note         | Failed - needs fix     | Public Apple software search returned 5 fuzzy results and no exact `Ryvro` / `Ryvro Shift Planner` result at `2026-06-01T19:15:52.766Z`. Logged-in App Store Connect check on 2026-06-05 reached Apps as Ilyasu Seidu and showed no apps, but new app creation is blocked until the Account Holder reviews and accepts the updated Apple Developer Program License Agreement. |
| Google Play title `Ryvro Shift Planner` and package `com.ryvro.shiftplanner` | Play Console app/package dashboard note                                               | Pending owner evidence | Public Google Play search had no exact `Ryvro` / `Ryvro Shift Planner` result at `2026-06-01T19:15:52.766Z`; visible fuzzy names were `Rydoo`, `Rydora`, `Ryver`, and `Ryver LLC`; still requires logged-in Play Console package/title check.                                                                                                                                 |
...
| Item                    | Required evidence                                                                         | Status                 | Evidence location or notes                                                                                                                                                                                                                                                                                                 |
| ----------------------- | ----------------------------------------------------------------------------------------- | ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Apple Developer account | Team ID and membership status                                                             | Failed - needs fix     | Logged-in App Store Connect check on 2026-06-05 reached the Apps page as Ilyasu Seidu, but App Store Connect showed: "Apple Developer Program License Agreement Updated." The Account Holder must accept the updated agreement at `developer.apple.com/account` before existing apps can be updated or new apps submitted. |
