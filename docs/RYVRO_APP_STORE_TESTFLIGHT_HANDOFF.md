...
- App Store Connect TestFlight previously showed version `1.0.0`, build `1`, status `Ready to Submit`; build `2` is now uploaded and awaiting Apple processing before TestFlight install evidence can be captured.
