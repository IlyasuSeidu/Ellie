...
- Recent pushed PR gate evidence includes GitHub Actions CI run `26727022362` on commit `90e3e04`, which passed Lint and Type Check, Unit Tests, Build Check, and the dedicated Release Check job running `npm run release:check` with the owner handoff preflight.
