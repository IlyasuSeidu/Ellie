...
- Recent pushed PR gate evidence includes GitHub Actions CI run `27002675763` on commit `02947b1`, CI run `27002389818` on commit `23d1a71`, and CI run `27002002928` on commit `683c2bb`, which passed Lint and Type Check, Unit Tests, Build Check, and the dedicated Release Check job running `npm run release:check` with the owner handoff preflight.
