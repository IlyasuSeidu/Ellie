...
- Latest local gate: `npm run release:check` passed on 2026-05-31 with 110 Jest suites, 1,766 tests, 4 snapshots, the Ryvro native scaffold preflight, the store readiness preflight, the owner handoff preflight, and backend build.
