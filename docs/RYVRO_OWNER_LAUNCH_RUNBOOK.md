...
- Recent pushed PR gate evidence includes GitHub Actions CI run `26735606843` on commit `f194981`, CI run `26728238458` on commit `d7f8f0e`, and CI run `26728115119` on commit `50bc770`, which passed Lint and Type Check, Unit Tests, Build Check, and the dedicated Release Check job running `npm run release:check` with the owner handoff preflight.
