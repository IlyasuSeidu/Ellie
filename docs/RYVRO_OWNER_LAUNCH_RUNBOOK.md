...
- Latest local gate: `npm run release:check` passed on 2026-06-09 after aligning the active testing strategy with current Ryvro launch gates, with TypeScript, 112 Jest suites, 1,795 tests, 4 snapshots, the Ryvro native scaffold preflight, the store readiness preflight, the owner handoff preflight, and backend build.
