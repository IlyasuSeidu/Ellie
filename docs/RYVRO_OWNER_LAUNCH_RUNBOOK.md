...
- Recent pushed PR gate evidence includes GitHub Actions CI run `26727378127` on commit `5101ca3`, CI run `26727184078` on commit `35a453c`, and CI run `26727022362` on commit `90e3e04`, which passed Lint and Type Check, Unit Tests, Build Check, and the dedicated Release Check job running `npm run release:check` with the owner handoff preflight.
