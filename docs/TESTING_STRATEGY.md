...
- `npm run release:check` passes TypeScript, 112 Jest suites / 1,801 tests / 4 snapshots, the Ryvro native scaffold preflight, the store readiness preflight, the owner handoff preflight, and backend build.
