...
- Confirm the internal tester list and opt-in link in Play Console before physical Android QA.
...
- Confirm the Google Play internal testing submission is visible in Play Console and share the opt-in link with testers.
