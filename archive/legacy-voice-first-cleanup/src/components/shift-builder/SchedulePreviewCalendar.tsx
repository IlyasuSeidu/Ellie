...
export const SchedulePreviewCalendar: React.FC<SchedulePreviewCalendarProps> = ({
  ...
  const days = useMemo<DayData[]>(() => {
    ...
    for (let i = 0; i < range; i++) {
      ...
      let color: string = 'rgba(214, 231, 242, 0.14)';
      let icon = 'ellipse';
      let label = '';
      ...
      >
        ...
        {day.isAnchor && (
          <View style={styles.anchorBadge}>
            <Ionicons name="flag" size={8} color={'#20f4dc'} />
          </View>
        )}
      </View>
    );
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.emptyState}>
          <Ionicons name="eye-outline" size={32} color={'#6f8798'} />
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.legend}>
        ...
        <View style={styles.legendItem}>
          <Ionicons name="flag" size={10} color={'#20f4dc'} />
