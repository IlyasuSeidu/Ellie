...
- Cover text: Better copy did not fix this onboarding problem.
- Top comment prompt: Where does your onboarding ask users to think too hard too early?

## Post

### Script

Better copy did not fix this onboarding problem.

I assumed the roster step felt hard because it needed clearer wording.
...
If a user has to work this hard before first value, they churn silently.

Where does your onboarding ask users to think too hard too early?
...
Proof from this pass: 11 locales updated and 32 tests touched.
