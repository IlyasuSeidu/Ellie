...
- Angle Mix: Design Tradeoff + Mini Case Study
- Cover text: Readable is not relatable.
- Final slide CTA: Which onboarding screen in your app sounds "correct" but still feels confusing?
...
6. Product lesson: language consistency can remove friction faster than new UI.
7. Which onboarding screen in your app sounds "correct" but still feels confusing?
...
I kept the same flow and clarified the promise across setup, Aha, and paywall.

Result: a cleaner path from effort to payoff for shift workers.
