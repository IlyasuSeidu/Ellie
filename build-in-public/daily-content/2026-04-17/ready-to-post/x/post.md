...
- Reply seed: Which transition is the biggest trust leak in your product right now?
...
4. Then we aligned the surrounding flows so the answer stays dependable under real shift usage.

5. Evidence: 11 locale packs touched and 27 tests touched in this reliability pass.

6. Which transition is the biggest trust leak in your product right now?
...
3. Setup state carryover + shift/date consistency came first.

4. 11 locales and 27 tests moved with that decision.

5. Where does your product feel most fragile in transition?
