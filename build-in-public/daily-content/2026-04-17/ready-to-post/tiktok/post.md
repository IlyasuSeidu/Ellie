...
- Cover text: I watched one setup glitch erase user confidence.
- Pinned comment: What’s the one bug that made you uninstall a useful app?

## Post

### Script

I watched one setup glitch erase user confidence in seconds.

The app had the right features, but the flow could still feel inconsistent once people moved between onboarding, reminders, and voice.

So we rebuilt the path: setup carries, shift/date logic lines up, and paywall/recovery moments are less fragile.
