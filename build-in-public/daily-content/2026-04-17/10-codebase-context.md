...
- `src/components/voice/VoiceAssistantModal.tsx`: VoiceAssistantModal Full-screen modal for the Ryvro voice assistant. (physics-based motion that needs to feel solid, localized copy and language-aware UI, calendar-based shift setup, and tests around the interaction and logic)
