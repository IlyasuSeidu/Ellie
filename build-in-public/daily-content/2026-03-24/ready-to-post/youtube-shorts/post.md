...
- Cover text: Why "correct" onboarding copy still fails.
- Top comment prompt: Which onboarding screen loses users fastest?
...
- 11 locales updated for CTA clarity
- paywall CTA hardened
- onboarding screens adjusted for long-locale resilience
- test coverage expanded on those paths

Localization is product behavior, not just copy replacement.

Which onboarding screen loses users fastest in your app?
...
- tests around failure-prone UI states
