...
- Re-ran local release clearance preflight, focused rebrand tests, full project validation, and GitHub CI after the launch-readiness cleanup. Recent pushed CI evidence for this branch passed on 2026-06-05: CI run `27011713114` on commit `885089b`.
