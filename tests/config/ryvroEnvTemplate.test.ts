...
describe('Ryvro environment template', () => {
  ...
  it('keeps the README release status aligned with current Ryvro launch readiness', () => {
    ...
    expect(readme).toContain('110 Jest suites / 1,779 tests / 4 snapshots');
    ...
    expect(readme).toContain('GitHub Actions CI run `26776633987`');
    expect(readme).toContain('commit `7a51dc6`');
    expect(readme).toContain('CI run `26776194564`');
    expect(readme).toContain('commit `63cbbef`');
    expect(readme).toContain('CI run `26735606843`');
    ...
    expect(readme).toContain('Testing infrastructure (1,779 tests in the latest release check)');
    ...
    expect(readme).toContain('Jest (1,779 tests in the latest release check)');
    expect(readme).toContain('Current Status (as of 2026-06-01 release check)');
    expect(readme).toContain('Total Tests**: 1,779 passing (110 Jest suites, 4 snapshots)');
  ...
  it('keeps the Ryvro release readiness report explicit about evidence and remaining blockers', () => {
    ...
    expect(readinessReport).toContain('110 Jest suites / 1,779 tests');
  ...
  it('keeps the owner launch runbook sequenced for the remaining account and device work', () => {
    ...
    expect(ownerRunbook).toContain('110 Jest suites, 1,779 tests');
    ...
    expect(ownerRunbook).toContain('CI run `26776194564`');
    expect(ownerRunbook).toContain('commit `63cbbef`');
    expect(ownerRunbook).toContain('CI run `26735606843`');
    expect(ownerRunbook).toContain('commit `f194981`');
