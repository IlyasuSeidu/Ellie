...
export const ShiftBlockCard: React.FC<ShiftBlockCardProps> = ({
  ...
  return (
    <Animated.View style={[styles.container, isDragging && styles.dragging, animatedStyle]}>
      ...
      >
        <Ionicons name="reorder-three" size={20} color={theme.colors.shadow} />
      </TouchableOpacity>
      ...
      <View style={styles.moveControls}>
        ...
        >
          <Ionicons
            name="chevron-up"
            size={16}
            color={isFirst ? theme.colors.shadow : theme.colors.dust}
          />
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Ionicons
            name="chevron-down"
            size={16}
            color={isLast ? theme.colors.shadow : theme.colors.dust}
          />
        </TouchableOpacity>
      </View>
    </Animated.View>
